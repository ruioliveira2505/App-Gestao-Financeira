...
A segunda — os **movimentos** (entradas e saídas de dinheiro numa conta, ainda sem categoria) — está feita de ponta a ponta:
...
A seguir: a **categorização** dos movimentos — primeiro uma tabela de categorias com CRUD manual, depois a atribuição automática com um modelo de linguagem; e, mais tarde, a importação por **Open Banking** e o scroll infinito no histórico.
