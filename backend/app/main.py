...
definidas nos routers (por agora, só as de autenticação). É este ficheiro
que o servidor (Uvicorn) corre para pôr a API no ar.
"""
...
# app.routers é o pacote onde vivem os ficheiros de rotas; por agora,
# apenas auth (autenticação). Importa-se o módulo "auth" inteiro, e não
# directamente o "router" lá definido, só por preferência de estilo — ambas
# as formas funcionariam.
...
# código mas nunca seriam alcançáveis por um pedido HTTP real — o FastAPI
# só sabe responder a rotas que tenham sido explicitamente incluídas.
